...
median tracking time: 0.017951
mean tracking time: 0.0184483
...
APE
```
selina-xiangqi@selina-xiangqi-Legion-R9000P-ARX8:~/ucl2024/robotVision_Navigation/COMP0249_24-25_ORB_SLAM2/dataset/g10_dataset$ evo_ape tum indoor/indoor_results.txt indoor/indoor_colmap_results.txt  -as --plot --plot_mode xz --save_plot indoor_ape.png
APE w.r.t. translation part (m)
(with Sim(3) Umeyama alignment)
...
RPE
```
selina-xiangqi@selina-xiangqi-Legion-R9000P-ARX8:~/ucl2024/robotVision_Navigation/COMP0249_24-25_ORB_SLAM2/dataset/g10_dataset$ evo_rpe tum indoor/indoor_results.txt indoor/indoor_colmap_results.txt  -as --plot --plot_mode xz --save_plot indoor_rpe.png
RPE w.r.t. translation part (m)
for delta = 1 (frames) using consecutive pairs
(with Sim(3) Umeyama alignment)
